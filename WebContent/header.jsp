...
<%@page import="cn.jbit.dto.UserDTO"%>
...
<body>
		<div id="header">
			...
			<div class="f_r w62p">
				<ul>
					<li class="txt hello">你好，欢迎<%
					UserDTO userDTO = (UserDTO)session.getAttribute("userDTO");
					if(null != userDTO){
						out.print(userDTO.getMyName());
					}
													%>访问贵美商城！<span id="timespan"></span></li>
				</ul>
			</div> 
  		<div class="nav f_l w100p">
  			...
  			<li><a href="index.jsp" target="_parent">&nbsp;首&nbsp;&nbsp;&nbsp;页&nbsp;</a></li>
  				<%
  					List<CategoryDTO> resultList = (List<CategoryDTO> )session.getAttribute("initNavigatorList");
  					for(int i = 0 ; i < resultList.size() ; i ++){
  						out.print("<li><a href='showProductByCategoryAction.action?productQueryDTO.categoryQueryDTO.parent.id="+resultList.get(i).getId()+"' target='_parent'>"+resultList.get(i).getName()+"</a></li>");
  					}
  				%>
